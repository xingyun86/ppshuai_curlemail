// curlpop3.cpp : main source file for curlpop3.exe
//
...
//		run nmake -f curlpop3ps.mk in the project directory.
#include "initguid.h"
#include "curlpop3.h"
#include "curlpop3_i.c"
...
//	HRESULT hRes = ::CoInitializeEx(NULL, COINIT_MULTITHREADED);
	...
	while(lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_CURLPOP3, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_CURLPOP3, TRUE);
